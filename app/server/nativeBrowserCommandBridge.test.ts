...
describe("native browser command bridge", () => {
  ...
  it("exposes one preload command and one main-process handler", async () => {
    ...
    expect(preloadSource).toContain("nativeBrowserSiteSettingsChannel");
    expect(preloadSource).toContain("nativeBrowserAllowPopupsHereChannel");
    expect(preloadSource).toContain("nativeBrowserSetBlockingForSiteChannel");
    ...
    expect(preloadSource).toContain("siteSettings");
    expect(preloadSource).toContain("allowPopupsHere");
    expect(preloadSource).toContain("setBlockingForSite");
    ...
    expect(bridgeSource).toContain("nativeBrowserSiteSettingsChannel");
    expect(bridgeSource).toContain("nativeBrowserAllowPopupsHereChannel");
    expect(bridgeSource).toContain("nativeBrowserSetBlockingForSiteChannel");
    expect(bridgeSource).toContain("applyNativeBrowserBlockingForUrl");
