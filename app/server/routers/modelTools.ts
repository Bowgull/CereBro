...
const creativeLanes = [
  {
    ...
    forbiddenForPrivateModules: true,
  },
  {
  ...
  },
  {
    ...
    outputBoundary: "Use only for public, scrubbed, or user-approved inputs. Never for private-module work.",
...
const ollamaSetupPlan = {
  ...
  blockedFirstInstalls: [
    ...
    "Private-module generation models",
  ],
  testProcedure: [
