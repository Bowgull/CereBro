  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        data-hard-gate={gate}
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid max-h-[85vh] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-2 overflow-auto rounded-md border border-[#27313F] bg-[#11161D] p-2 text-[#F4EFE3] shadow-[0_20px_58px_rgba(0,0,0,0.46)] outline-none duration-200 data-[hard-gate=true]:border-[#D9A75F] data-[hard-gate=true]:bg-[#0D1218] data-[hard-gate=true]:ring-2 data-[hard-gate=true]:ring-[#D9A75F]/30 data-[hard-gate=true]:shadow-[0_0_0_1px_rgba(217,167,95,0.22),0_20px_58px_rgba(0,0,0,0.58)] data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 focus-visible:ring-2 focus-visible:ring-[#6BA6FF]/45 focus-visible:ring-offset-1 focus-visible:ring-offset-[#0E1116] sm:max-w-md",
          className
        )}
