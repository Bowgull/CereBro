...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("px-1.5 py-1 text-[10px] font-semibold uppercase leading-none text-[#D9B56A]", className)}
      {...props}
    />
  );
}
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("pointer-events-none -mx-1 my-0.5 h-px bg-[#334155]", className)}
      {...props}
    />
  );
}
