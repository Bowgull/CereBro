  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col border-[#334155] bg-[#181F2A] text-[#F4EFE3] shadow-[0_20px_60px_rgba(0,0,0,0.45)] outline-none focus-visible:ring-2 focus-visible:ring-[#6BA6FF]/45 focus-visible:ring-offset-1 focus-visible:ring-offset-[#0E1116]",
