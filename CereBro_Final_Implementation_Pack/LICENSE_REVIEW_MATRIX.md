...
| Impeccable site | https://impeccable.style/ | Public design workflow reference | Public site reviewed 2026-05-16 | Do not copy site copy/assets | Use as source for register-aware design discipline, shared design memory, and critique-loop concepts only. |
...
| Taste Skill | https://github.com/Leonxlnx/taste-skill and https://www.tasteskill.dev/ | Anti-slop frontend skill framework | MIT verified 2026-05-16 | Yes, with attribution | Direct reference the user meant. Study skill taxonomy and design discipline. Do not install or copy files without approval. |
| Taste with receipts | https://bravedog.co.uk/journal/ai-didnt-kill-designers-killed-lazy-design and https://www.houseofgai.com/blog/will-ai-replace-graphic-designers-creative | Design judgment article references | Public articles reviewed 2026-05-16 | Do not copy article copy | Secondary context only. Use as original CereBro rule: generated output must be edited down with visible rationale. |
